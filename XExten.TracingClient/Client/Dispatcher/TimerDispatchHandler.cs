...
namespace XExten.TracingClient.Client.Dispatcher
{
    public class TimerDispatchHandler: IDisposable
    {
        ...
        public TimerDispatchHandler(IEnumerable<IDispatchCallback> callbacks, ITraceLoggerFactory loggerFactory, int flushInterval)
        {
            _callbacks = callbacks;
            _flushInterval = flushInterval;
            _logger = loggerFactory.CreateTraceLogger(typeof(TimerDispatchHandler));
